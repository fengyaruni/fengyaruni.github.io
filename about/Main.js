...
//预定义一些颜色 颜色参考的是boostrap里的安全色,自己百度去 心好累
...
function createInstructions() {
	...
	'<span style="color:' + theme[0] + ';font-size:35px;">FengCai</span><br /><br /><span style="font-size:15px;"><strong>Runi</strong><br /><br />.<br />..<br />...<br />...<br />...</span>'
	||randNum==2&&	
	'<span style="color:' + theme[0] + ';font-size:35px;">FengCai</span><br /><br /><span style="font-size:15px;"><strong>Wish</strong><br /><br />.<br />..<br />...<br />...<br />...</span>'
    || randNum == 3 &&
	'<span style="color:' + theme[0] + ';font-size:35px;">FengCai</span><br /><br /><span style="font-size:15px;"><strong>Hope</strong><br /><br />.<br />..<br />...<br />...<br />...</span>'
